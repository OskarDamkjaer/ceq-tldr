...
import { courseHistory, courseHistoryYears, nameByCourse } from '../data/DataManagement'
...
const CourseContainer = ({ courseCode }) => (
  <div>
    ...
    {orderedHeadersStyledFiltered.slice(1).map((header, index) => (
      <CourseGraph dataArray={courseHistoryYears(courseCode)} tag={header} dataTag={orderedHeadersFiltered.slice(1)[index]} />
    ))
    }
    {' '}
    <div />
